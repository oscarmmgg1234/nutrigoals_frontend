          ...
          <View style={styles.bottomContainerWrapper}>
            <TouchableOpacity onPress={() => this.updateValue(1)}>
              ...
              <Image source={Images.home} style={{
                ...
                // marginTop: 14,
                alignSelf: 'center',
                tintColor: navigatinUpdate == 1 ? Colors.buttonColor : Colors.White
              }} />

            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.updateValue(2)}>
              <Image source={Images.book_open} style={{
                width: 35, height: 35,
                alignSelf: 'center',
                tintColor: navigatinUpdate == 2 ? Colors.buttonColor : Colors.White
              }} />
            ...
            <TouchableOpacity onPress={() => this.updateValue(3)}>
              ...
              <Image source={Images.instagram} style={{
                ...
                // marginTop: 14,
                alignSelf: 'center',
                tintColor: navigatinUpdate == 3 ? Colors.buttonColor : Colors.White
              }} />

            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.updateValue(4)}>

              <Image source={Images.user} style={{
                 width: 35, height: 35,
                // marginTop: 14,
                alignSelf: 'center',
                tintColor: navigatinUpdate == 4 ? Colors.buttonColor : Colors.White
              }} />
