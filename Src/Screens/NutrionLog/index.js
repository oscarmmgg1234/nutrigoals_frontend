                ...
                <View style={{
                  ...
                  <View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 10 }}>
                      ...
                      <Text style={[Styles.firstText, { marginLeft: 7, marginTop: 3 }]}>{'/ 2,2 L'}</Text>
                    </View>

                    <View style={{ flexDirection: 'row', marginTop: 30 }}>
                      <Image source={Images.clock} style={{ width: 20, height: 20 }} />
                      <Text style={[Styles.firstText, { marginLeft: 7, }]}>{'Last Drunk 9:34 AM'}</Text>
                    </View>
                  </View>
                  ...
                  <View style={{ flexDirection: 'row', marginRight: -50 }}>
                    ...
                    <View>
                      <TouchableOpacity style={Styles.buttonIncrement}>
                        <Text style={{ color: Colors.White, fontWeight: '600', fontSize: 20, textAlign: 'center' }}>{'+'}</Text>
                      </TouchableOpacity>
                    ...
                    <Progress.Bar progress={0.6} style={{
                      transform: [{ rotate: '-90deg' }],
                      height: 30, marginTop: 38, width: 100
                    }}
                      height={30}
                      color={'#18acbb'}
                      borderRadius={25}
