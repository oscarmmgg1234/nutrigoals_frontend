          ...
          <ScrollView>
            <View style={Styles.mainContainer}>
              ...
              <View style={Styles.emailMainContainer}>
                ...
                <View style={[Styles.emailWrapper, { borderColor: password.length > 0 ? '#62FF68' : passwordFocus ? Colors.buttonColor : Colors.backgroundColor }]}>
                  <TextInput
                    style={Styles.emailInput}
                    value={password}
              ...
              <View style={Styles.bottomWrapper}>
                <Text style={Styles.alreadyAccountText}>{Constants.DONT_HAVE_ACCOUNT}</Text>
              ...
              <Text style={Styles.socialTextStyling}>{Constants.LOGIN_DESCRIPTION}</Text>
